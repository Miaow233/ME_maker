...
Blockly.JavaScript['event_rotsys'] = function (block) {
    var a = block.getFieldValue("event_type");
    return [a, Blockly.JavaScript.ORDER_ATOMIC]
};

Blockly.JavaScript['event_values'] = function (block) {
    var a = "eventarray[" + block.getFieldValue("event_values") + "]";
    return [a, Blockly.JavaScript.ORDER_ATOMIC]
};
