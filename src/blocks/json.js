...
Blockly.Blocks["json_getkey"] = {
  init: function () {
    ...
    this.appendValueInput("VAR").setCheck("String");
    this.appendValueInput("propertyName").setCheck(null).appendField("中");
...
Blockly.Blocks["json_setkey"] = {
  init: function () {
    ...
    this.appendValueInput("propertyName").setCheck(null).appendField("中");
    this.appendDummyInput().appendField("的值");
    this.appendValueInput("valueName").setCheck(null).appendField("等于");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(240);
